...
st.markdown(
    ...
    .stSelectbox > div > div > div > div > div { color: #007bff; } /* Change color of dropdown options to blue */
    .stMultiSelect > div > div > div > div > div { color: #4A90E2; } /* Custom multiselect color */
...
# Metric Dropdown
sorted_metrics = sorted(SERIES_ID_NAME_MAP.values())
metric_name = st.sidebar.selectbox("Select Metric", sorted_metrics)
